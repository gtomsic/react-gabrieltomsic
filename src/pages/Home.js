  ...
  return (
    <div name="home" className="w-full h-screen bg-[#212529]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <h1 className="text-white   text-4xl md:text-6xl my-2">
          Gabriel Tomsic
        </h1>
        ...
        <p className="text-gray-400 text-2xl text-justify mt-5">
          ...
          ReactJS, HTML/CSS, SASS, NodeJS, Javascript, Github and more... As a
          software engineer, I thrive in this fast-paced environment.
        </p>
        <div>
